  ...
  return (
    ...
    <div className="embla relative">
      ...
      <button
        ...
        className="hidden md:flex absolute top-1/2 -translate-y-1/2 z-30 h-10 w-10 items-center justify-center rounded-full border border-black/70 bg-black/70 shadow dark:border-white/70 dark:bg-white/70"
